...
if ( function_exists( 'bt_bb_add_params' ) ) {
	bt_bb_add_params( 'bt_bb_headline', array(		
		array( 'param_name' => 'size', 'type' => 'dropdown', 'heading' => esc_html__( 'Size', 'denticare' ), 'description' => 'Predefined heading sizes, independent of html tag', 'responsive_override' => true,
			'value' => array(
				esc_html__( 'Inherit', 'denticare' ) => 'inherit',
...
function denticare_bt_bb_content_slider_item_class( $class, $atts ) {
...
add_filter( 'bt_bb_content_slider_item_class', 'denticare_bt_bb_content_slider_item_class', 10, 2 );


function denticare_bt_bb_fe( $elements ) {
	...
	$elements[ 'bt_bb_before_after_image' ] = array(
		...
		'params' => array(
			...
			//'coverage_image'    	=> array(),
		),
	);
	$elements[ 'bt_bb_features_table' ] = array(
		'edit_box_selector' => '',
		'params' => array(
			'title'				=> array(),	
			'table'				=> array(),
	...
	$elements[ 'bt_bb_organic_animation' ] = array(
		...
		'params' => array(
			...
			'button_size'      				=> array( 'js_handler' => array( 'target_selector' => '', 'type' => 'class' ) ),	
			'style'							=> array( 'js_handler' => array( 'target_selector' => '', 'type' => 'class' ) ),
			'button_text'      				=> array( 'js_handler' => array( 'target_selector' => '.item__button_link', 'type' => 'inner_html' ) ),
...
add_filter( 'bt_bb_fe_elements', 'denticare_bt_bb_fe' );