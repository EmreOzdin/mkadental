...
BoldThemes_Customize_Default::$data['heading_font'] = 'Playfair Display';
...
BoldThemes_Customize_Default::$data['accent_color'] = '#fdabb7';
BoldThemes_Customize_Default::$data['alternate_color'] = '#333c4a';
...
BoldThemes_Customize_Default::$data['change_number_ligatures'] = false;

// Match theme styles by default
BoldThemes_Customize_Default::$data['template_dash_design'] = '';
BoldThemes_Customize_Default::$data['template_headline_style'] = 'Accent';
BoldThemes_Customize_Default::$data['supertitle_position'] = true;
BoldThemes_Customize_Default::$data['menu_type'] = 'horizontal-below-left';
BoldThemes_Customize_Default::$data['boxed_menu'] = true;
BoldThemes_Customize_Default::$data['sticky_header'] = false;
BoldThemes_Customize_Default::$data['below_menu'] = true;
BoldThemes_Customize_Default::$data['header_style'] = 'transparent-light';
BoldThemes_Customize_Default::$data['sidebar_use_dash'] = false;
BoldThemes_Customize_Default::$data['menu_font_size'] = '16';
BoldThemes_Customize_Default::$data['menu_focus_element'] = 'Circle';
...
BoldThemes_Customize_Default::$data['shop_sale_tag_design'] = 'hard-rounded';
