...
class bt_bb_column extends BT_BB_Element {
	...
	function map_shortcode() {
		bt_bb_map( $this->shortcode, array( 'name' => esc_html__( 'Column', 'denticare' ), 'description' => esc_html__( 'Column element', 'denticare' ), 'width_param' => 'width', 'container' => 'vertical', 'accept' => array( 'bt_bb_section' => false, 'bt_bb_row' => false, 'bt_bb_column' => false, 'bt_bb_column_inner' => false, 'bt_bb_tab_item' => false, 'bt_bb_accordion_item' => false, 'bt_bb_cost_calculator_item' => false, 'bt_cc_group' => false, 'bt_cc_multiply' => false, 'bt_cc_item' => false, 'bt_bb_content_slider_item' => false, 'bt_bb_google_maps_location' => false, '_content' => false ), 'accept_all' => true, 'toggle' => false, 'responsive_override' => true,
			'params' => array(
				array( 'param_name' => 'align', 'type' => 'dropdown', 'heading' => esc_html__( 'Align', 'denticare' ), 'preview' => true, 'responsive_override' => true,
					'value' => array(
				...
				array( 'param_name' => 'order', 'type' => 'dropdown', 'heading' => esc_html__( 'Order', 'denticare' ), 'default' => '0', 'responsive_override' => true, 'description' => esc_html__( 'Columns are placed in the visual order according to selected order, lowest values first.', 'denticare' ),
					'value' => array(
						...
						esc_html__( ' 0 (default)', 'denticare' ) => '0',
						esc_html__( ' 1', 'denticare' ) => '1',
						esc_html__( ' 2', 'denticare' ) => '2',
						esc_html__( ' 3', 'denticare' ) => '3',
						esc_html__( ' 4', 'denticare' ) => '4',
				...
				array( 'param_name' => 'opacity', 'type' => 'textfield', 'heading' => esc_html__( 'Background color opacity (deprecated)', 'denticare' ), 'group' => esc_html__( 'Design', 'denticare' ) ),
